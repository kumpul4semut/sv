...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/dugong-lewat/node/main/zero/allow/vps | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
    echo -e "\e[32mSTATUS SCRIPT AKTIF...\e[0m"
    else
    echo -e "\e[31mSCRIPT ANDA EXPIRED!\e[0m";
    echo -e "\e[31mSilahkan Renew IP \e[0m"
    exit 0
fi
}
...
echo -e "\e[31mDaftarkan IP dulu yah #\e[0m"
exit 0
fi
clear 
